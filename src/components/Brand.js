...
const Brand = () => {
  ...
  const garmentWished = garment.filter(
    (garment) => garment.status === "wishlist"
  );
              ...
              <div key={brand.id}>
                <div className="flex-box-centered">
                  ...
                  <img
                    ...
                    src={
                      brand.imageUrl.includes("http")
                        ? `${brand.imageUrl}`
                        : `../../assets/${brand.imageUrl}`
                    }
                  ></img>
                </div>
                <div className="brand-buttons-container">
                  <Link to={`/brands/edit/${id}`}>
                    <button className="form-button">Edit Brand</button>
                  </Link>
                  <button
