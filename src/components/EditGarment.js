    ...
    return(
         <div>
            <form className="add-garment-form" onSubmit={submit}>
                ...
                <input placeholder={garment.price} onChange={(ev) => {
                    setPrice(ev.target.value)
                }}></input>
                <label htmlFor="name">Price</label>
                <input placeholder={garment.imageUrl}  onChange={(ev) => {
                    setImageUrl(ev.target.value)
                }}></input>
                <label htmlFor="name">Image URL</label>
                <select placeholder={garment.status} onChange={(ev) => {
                ...
                <select placeholder={garment.garmentType} onChange={(ev) => {
                ...
                <select placeholder={garment.size} onChange={(ev) => {
                ...
                <select placeholder={garment.state}  onChange={(ev) => {
                ...
                <select placeholder={garment.brand}  onChange={(ev) => {
                   const brand = brands.find(brand => brand.name === ev.target.value).id
                   setBrandId(brand)
                }}>
                <option>{
